...
[![Coverage Status](https://coveralls.io/repos/github/opensds/soda-controller/badge.svg?branch=master)](https://coveralls.io/github/opensds/soda-controller?branch=master)
...
- Raise your idea as an [issue](https://github.com/opensds/soda-controller/issues)
...
- After reaching consensus in the issue discussions and design proposal reviews, complete the development on the forked repo and submit a PR. 
  Here are the [PRs](https://github.com/opensds/soda-controller/pulls?q=is%3Apr+is%3Aclosed) that are already closed.
