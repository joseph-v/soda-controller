...
`Hotpot <https://github.com/opensds/soda-controller/releases/tag/v0.4.0>`__
...
`Dashboard <https://github.com/opensds/soda-controller-dashboard/releases/tag/v0.4.0>`__
`Installer <https://github.com/opensds/soda-controller-installer/releases/tag/v0.4.0>`__
...
`Hotpot <https://github.com/opensds/soda-controller/releases/tag/v0.2.0>`__
`Sushi <https://github.com/opensds/nbp/releases/tag/v0.2.0>`__
`Installer <https://github.com/opensds/soda-controller-installer/releases/tag/v0.2.0>`__
